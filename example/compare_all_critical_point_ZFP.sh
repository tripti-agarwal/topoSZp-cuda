...
# Supports both .dat.SZ3.out and .dat.zfp.out decompressed files
...
if [ $# -lt 4 ]; then
    ...
    echo "  decompressed_suffix: Optional suffix for decompressed files (default: .SZ3.out or .zfp.out)"
    echo ""
    echo "Examples:"
...
COLS="$3"
ERROR_BOUND="$4"
DECOMPRESSED_SUFFIX="${5:-.SZ3.out}"  # Default to .SZ3.out if not specified
